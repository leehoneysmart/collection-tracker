                    ...
                    if show_form:
                        ...
                        with st.form(key="collection_form"):                            
                            ...
                            if st.session_state.collection_method in ["Tracked Envelope", "Tracked Box"]:
                                ...
                                address = st.text_area("Address (For Mailing)", placeholder="Optional for reference", height=80)
...
with st.sidebar:
    ...
    st.markdown("📩 Tracked Envelope: **+$3.00**")
    st.markdown("📦 Tracked Box: **+$3.80**")
    st.markdown("🏠 Self-Collect: **Free** (NUS / Bishan)")
    st.markdown("🤝 Meet-up: **Free** (Clementi / Buona Vista / Kent Ridge MRT)")
    st.markdown("---")
    st.markdown("**Need Help?**")
    st.markdown("📞 pm **@ajelsss**")
    st.markdown("---")
