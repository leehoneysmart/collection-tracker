...
if user_input and not st.session_state.submitted:
    ...
    st.markdown("""
        <div class="welcome-box">
            ...
            <hr>
            <p style="font-size: 12px;>𓇼 website works best with light mode! click on the 3 dots on the top right to adjust! </p>
            <p style="font-size: 12px;>𓇼 please read details on the side bar first before filling up the form!</p>
            <p style="font-size: 12px;>𓇼 please collect your items within 3 weeks of notification! </p>
            <p style="font-size: 12px;>𓇼 consolidation limited to maximum 2 batches! </p>
            <p style="font-size: 12px;>𓇼 late fee of $1/day applies after 3 weeks!</p>
        </div>
    """, unsafe_allow_html=True)
